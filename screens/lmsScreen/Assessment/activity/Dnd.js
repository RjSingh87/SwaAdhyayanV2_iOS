    ...
    for (let i = 0; i < 8; i++) {
      ...
      if (optionsId != 0) {
        ...
        if (optionsData != '' && optionsImg != '') {
          ...
          if (ext1[1] !== undefined && (ext1[1] == 'png' || ext1[1] == 'PNG' || ext1[1] == 'jpeg' || ext1[1] == 'jpg' || ext1[1] == 'JPG' || ext1[1] == 'gif' || ext1[1] == 'web')) {
            let imgPath = 'https://swaadhyayan.com/data/' + DndData.imagePath + optionsData
            allDndData += `<div style='text-align:center'><img style='height:${DndData.optionImageHight}px; max-width:250px;' src=${imgPath} /></div>`
          } else {
            allDndData += optionsData.replace(/#/g, '__________');
          }
        ...
        <View style={{ backgroundColor: SWATheam.SwaWhite }}>
          <View style={{ backgroundColor: '#efefef', padding: 8, borderRadius: 6, margin: 8 }}>
            <View style={{ padding: 3, margin: 4, backgroundColor: '#93ced0', borderRadius: 6 }}>
              <View style={{ flexDirection: 'row' }}>
                <View style={{ width: '100%', padding: 4, margin: 2, borderRadius: 6, borderBottomWidth: .7, borderColor: SWATheam.SwaWhite }}>
                  <Text style={{ color: SWATheam.SwaBlack, fontWeight: '700', textAlign: 'center' }}>Chapter:{dndData.chapterName}</Text>
                </View>
              </View>

              <View style={{ flexDirection: 'row' }}>
                <View style={{ width: '70%', padding: 2, margin: 2, borderRadius: 6 }}>
                  <Text style={{ color: SWATheam.SwaBlack }}>Type:DND</Text>
                </View>
                <View style={{ width: '27%', padding: 2, margin: 2, borderRadius: 6 }}>
                  <Text style={{ color: SWATheam.SwaBlack, textAlign: 'right' }}>Marks:{dndData.marksPerQuestion}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={{ flexDirection: 'row', padding: 3, justifyContent: 'space-between', alignContent: 'center', alignItems: 'center', margin: 4, backgroundColor: '#93ced0', borderRadius: 6 }}>
              {selectedQuesIDsArray.includes(dndData.questionID + "|" + dndData.marksPerQuestion) == true ?
                <>
                  ...
                  <TouchableOpacity onPress={() => { selectedQuesIDs(dndData.questionID, dndData.marksPerQuestion); setReload(false) }} style={{ width: '25%', padding: 5, margin: 4, backgroundColor: '#cd5c5c', borderRadius: 6 }}>
                    <Text style={{ textAlign: 'center', color: SWATheam.SwaWhite }}>Deselect</Text>
                  </TouchableOpacity>
                </>
                :
                <>
                  <TouchableOpacity onPress={() => { editMarks(dndData.questionID) }} style={{ width: '20%', padding: 5, margin: 4, backgroundColor: '#efefef', borderRadius: 6 }}>
                    <Text style={{ textAlign: 'center', color: SWATheam.SwaBlack }} >Edit</Text>
                  </TouchableOpacity>
                  {/* <View style={{ width: '50%', padding: 5, margin: 4 }}>
                  </View> */}
                  <TouchableOpacity onPress={() => { selectedQuesIDs(dndData.questionID, dndData.marksPerQuestion); setReload(true) }} style={{ width: '25%', padding: 5, margin: 4, backgroundColor: '#efefef', borderRadius: 6 }}>
            ...
            <View style={{ flexDirection: 'row', padding: 3, justifyContent: 'space-between', alignContent: 'center', alignItems: 'center', margin: 4, backgroundColor: '#93ced0', borderRadius: 6 }}>
              {selectedQuesIDsArray.includes(dndData.questionID + "|" + dndData.marksPerQuestion) == true ?
                <>
                  ...
                  <TouchableOpacity onPress={() => { selectedQuesIDs(dndData.questionID, dndData.marksPerQuestion); setReload(false) }} style={{ width: '20%', padding: 5, margin: 4, backgroundColor: '#cd5c5c', borderRadius: 6 }}>
                    <Text style={{ textAlign: 'center', color: SWATheam.SwaWhite }}>Deselect</Text>
                  </TouchableOpacity>
                </>
                :
                <>
                  ...
                  <TouchableOpacity onPress={() => { selectedQuesIDs(dndData.questionID, dndData.marksPerQuestion); setReload(true) }} style={{ width: '20%', padding: 5, margin: 4, backgroundColor: '#efefef', borderRadius: 6 }}>
